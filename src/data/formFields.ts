...
export const activityFields: Record<string, ActivityField[]> = {
  ...
  "Innovative Teaching Pedagogy": [
    ...
    { name: "pedagogyType", label: "Teaching Approach / Method", type: "text", placeholder: "e.g., Flipped Classroom, Problem-based Learning, Peer Teaching", helperText: "Describe the innovative approach used in teaching." },
    { name: "implementationYear", label: "Year Implemented", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
    { name: "description", label: "Brief Description", type: "textarea", fullWidth: true, helperText: "Describe what was done and how it benefited students." },
  ],
  "Guest Lecture Organized": [
    ...
    { name: "department", label: "Department / Program", type: "text" },
    { name: "studentCount", label: "Number of Students", type: "number" },
  ],
  "Development of Study Material": [
    { name: "materialTitle", label: "Title of Material", type: "text", required: true },
    { name: "materialType", label: "Type of Material", type: "select", options: ["Notes", "Textbook", "Case Studies", "Problem Sets", "Practical Guide", "Other"] },
    { name: "courseName", label: "Course / Subject Name", type: "text" },
    { name: "description", label: "Brief Description", type: "textarea", fullWidth: true },
  ],
  "E-learning Content / LMS Material": [
    { name: "contentTitle", label: "Content Title", type: "text", required: true },
    { name: "lmsName", label: "Platform / Tool Used", type: "text", placeholder: "e.g., Moodle, Google Classroom, YouTube, MS Teams", helperText: "Name the platform or tool where the content was published (if any)." },
    { name: "courseName", label: "Course / Subject Name", type: "text" },
    { name: "moduleCount", label: "Number of Modules / Videos", type: "number" },
    { name: "description", label: "Content Overview", type: "textarea", fullWidth: true },
  ],
  "Smart Classroom Practices": [
    { name: "practiceTitle", label: "Initiative / Practice Title", type: "text", required: true },
    { name: "technology", label: "Technology / Tool Used", type: "text", placeholder: "e.g., Smart Board, Projector, Online Quiz Tool", helperText: "Mention any technology or digital tools used." },
    { name: "courseName", label: "Course / Subject Name", type: "text" },
    { name: "outcomes", label: "Observed Benefits / Outcomes", type: "textarea", fullWidth: true },
  ],
  "New Teaching Method Introduced": [
    { name: "methodName", label: "Method / Initiative Name", type: "text", required: true },
    { name: "description", label: "How Was It Implemented?", type: "textarea", fullWidth: true, helperText: "Briefly describe the method and how it was applied in the classroom." },
    { name: "courseName", label: "Course / Subject Name", type: "text" },
  ...
  "Activity-based Learning": [
    ...
    { name: "courseName", label: "Course / Subject Name", type: "text" },
    { name: "activityType", label: "Type of Activity", type: "select", options: ["Group Discussion", "Simulation", "Experiential Learning", "Collaborative Project", "Field-based Activity", "Other"] },
  ...
  "Project-based Learning": [
    ...
    { name: "courseName", label: "Course / Subject Name", type: "text" },
    { name: "projectScope", label: "Project Scope / Description", type: "textarea", fullWidth: true, helperText: "Briefly describe the scope and objectives of the project." },
    { name: "studentCount", label: "Number of Students", type: "number" },
  ],
  "Outcome-based Teaching Practice": [
    { name: "practiceDescription", label: "Practice / Activity Description", type: "textarea", required: true, fullWidth: true, helperText: "Describe the practice and how it aligns with learning outcomes." },
    { name: "courseName", label: "Course / Subject Name", type: "text" },
    { name: "associatedOutcomes", label: "Course Outcomes Addressed", type: "textarea", helperText: "e.g., CO1, CO3 - Students will be able to..." },
  ],

  // TEACHING, LEARNING & EVALUATION - Curriculum Development
  "Syllabus Design": [
    { name: "courseName", label: "Course / Subject Name", type: "text", required: true },
    { name: "programName", label: "Program Name", type: "text" },
    { name: "semester", label: "Semester", type: "text" },
    { name: "outcomeAlignment", label: "How It Aligns with Outcomes", type: "textarea", helperText: "Briefly describe how the syllabus covers course / program outcomes." },
  ],
  "BOS Participation": [
    { name: "bosTitle", label: "Board of Studies Name", type: "text", required: true },
    { name: "role", label: "Your Role", type: "select", options: ["Member", "Chairperson", "Convener"] },
  ...
  "Course Revision / Upgradation": [
    { name: "courseName", label: "Course / Subject Name", type: "text", required: true },
    { name: "previousVersion", label: "Previous Version / Year", type: "text" },
    { name: "academicYear", label: "Academic Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
    { name: "revisionsApplied", label: "Changes / Revisions Made", type: "textarea", fullWidth: true },
  ],
  "New Course Design": [
    { name: "courseName", label: "Course / Subject Name", type: "text", required: true },
    { name: "courseCode", label: "Course Code", type: "text" },
    { name: "credits", label: "Credits", type: "number" },
    { name: "objectives", label: "Course Objectives / Goals", type: "textarea", fullWidth: true },
  ],
  "CO Design": [
    { name: "courseName", label: "Course / Subject Name", type: "text", required: true },
    { name: "coCount", label: "Number of Course Outcomes Defined", type: "number" },
    { name: "bloomLevel", label: "Bloom's Taxonomy Levels Covered", type: "text", placeholder: "e.g., Remember, Understand, Apply, Analyze" },
  ...
  "PO/PSO Mapping": [
    ...
    { name: "mappingType", label: "Type of Mapping Done", type: "select", options: ["PO-CO Mapping", "PSO-CO Mapping", "Both"] },
  ...
  "Gap Analysis in Curriculum": [
    ...
    { name: "gapIdentified", label: "Gaps / Issues Identified", type: "textarea", fullWidth: true, helperText: "List the gaps found in the existing curriculum." },
    { name: "suggestedImprovements", label: "Suggested Improvements", type: "textarea", fullWidth: true },
  ],
  "Industry Suggested Curriculum Input": [
    { name: "organizationName", label: "Industry / Organization Name", type: "text", required: true },
    { name: "suggestedTopics", label: "Topics / Skills Suggested", type: "textarea", fullWidth: true, helperText: "List the topics or skills recommended by the industry partner." },
    { name: "relevance", label: "Relevance to Program", type: "textarea" },
  ],

  // TEACHING, LEARNING & EVALUATION - Exam / Evaluation Work
  "Question Paper Setting": [
    { name: "subjectName", label: "Subject / Course Name", type: "text", required: true },
  ...
  "Question Paper Moderation": [
    ...
    { name: "feedbackProvided", label: "Feedback / Remarks Provided", type: "textarea", fullWidth: true },
  ],
  "Internal Assessment (ISE/CA)": [
    { name: "subjectName", label: "Subject / Course Name", type: "text", required: true },
    { name: "assessmentMethod", label: "Assessment Method Used", type: "select", options: ["Quiz", "Assignment", "Project", "Presentation", "Class Test", "Mixed"] },
    { name: "semester", label: "Semester", type: "text" },
  ...
  "Answer Sheet Evaluation": [
    { name: "examType", label: "Exam / Subject Name", type: "text", required: true },
    { name: "sheetsEvaluated", label: "Number of Answer Sheets Evaluated", type: "number" },
    { name: "semester", label: "Semester", type: "text" },
    { name: "evaluationDate", label: "Evaluation Date", type: "date" },
  ],
  "Practical Examination": [
    { name: "subjectName", label: "Subject / Lab Name", type: "text", required: true },
    { name: "studentCount", label: "Number of Students", type: "number" },
    { name: "practicalType", label: "Practical Type", type: "select", options: ["Lab Work", "Workshop", "Field Work", "Skill Demonstration"] },
    { name: "semester", label: "Semester", type: "text" },
  ],
  "Viva Examination": [
    { name: "subjectName", label: "Subject / Project Name", type: "text", required: true },
    { name: "studentCount", label: "Number of Students Examined", type: "number" },
    { name: "examDate", label: "Date of Viva", type: "date" },
  ],
  "Lab Evaluation": [
    { name: "labName", label: "Lab / Subject Name", type: "text", required: true },
    { name: "courseCode", label: "Course Code", type: "text" },
    { name: "studentCount", label: "Number of Students", type: "number" },
    { name: "evaluationCriteria", label: "Evaluation Criteria Used", type: "textarea" },
  ],
  "Exam Supervision / Invigilation": [
    ...
    { name: "date", label: "Date of Exam", type: "date" },
  ],
  "Result Analysis": [
    { name: "subjectName", label: "Subject / Course Name", type: "text", required: true },
    { name: "classSize", label: "Class Size", type: "number" },
    { name: "avgScore", label: "Average Score / Pass %", type: "text" },
    { name: "analysis", label: "Observations / Analysis", type: "textarea", fullWidth: true },
  ],

  // TEACHING, LEARNING & EVALUATION - Student Projects / Internships
  "UG Project Guidance": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "studentNames", label: "Student Name(s)", type: "textarea", helperText: "Enter one student name per line." },
    { name: "domain", label: "Project Domain / Area", type: "text" },
  ...
  "Internship Mentoring": [
    ...
    { name: "duration", label: "Duration", type: "text", placeholder: "e.g., 6 weeks, 2 months" },
    { name: "projectDescription", label: "Internship Work / Project Description", type: "textarea", fullWidth: true },
  ],
  "Industry Project Mentoring": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "organizationName", label: "Industry / Organization Name", type: "text" },
    { name: "studentTeamSize", label: "Number of Students in Team", type: "number" },
    { name: "outcomes", label: "Project Outcomes / Deliverables", type: "textarea", fullWidth: true },
  ],
  "Capstone Project Guidance": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "studentTeamSize", label: "Number of Students in Team", type: "number" },
    { name: "scope", label: "Project Scope / Objectives", type: "textarea", fullWidth: true, helperText: "Briefly describe the project goals and scope." },
  ...
  "PG Dissertation Guidance": [
    ...
    { name: "program", label: "Program / Course", type: "text" },
    { name: "researchArea", label: "Research Area / Topic", type: "text" },
  ],
  "PhD Supervision": [
  ...
  "Student Innovation Project": [
    ...
    { name: "studentNames", label: "Student Name(s)", type: "textarea", helperText: "Enter one student name per line." },
    { name: "innovationType", label: "Type / Area of Innovation", type: "text" },
  ...
  "Hackathon / Competition Mentoring": [
    ...
    { name: "studentCount", label: "Number of Students Mentored", type: "number" },
    { name: "achievement", label: "Achievement / Award Won", type: "text" },
    { name: "details", label: "Additional Details", type: "textarea", fullWidth: true },
  ],
  ...
  "Scopus Indexed Journal Paper": [
    ...
    { name: "quartile", label: "Journal Quartile", type: "select", options: ["Q1", "Q2", "Q3", "Q4"] },
  ],
  "SCI / SCIE / ESCI Publication": [
    { name: "paperTitle", label: "Paper Title", type: "text", required: true },
    { name: "journalName", label: "Journal Name", type: "text", required: true },
    { name: "doi", label: "DOI / URL", type: "text" },
    { name: "indexingType", label: "Indexing Type", type: "select", options: ["SCI", "SCIE", "ESCI"] },
    { name: "publicationYear", label: "Publication Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  ...
  "UGC CARE Journal Paper": [
    { name: "paperTitle", label: "Paper Title", type: "text", required: true },
    { name: "journalName", label: "Journal Name", type: "text", required: true },
    { name: "journalList", label: "UGC CARE List Category", type: "select", options: ["List 1", "List 2", "List 3", "List 4"] },
    { name: "publicationYear", label: "Publication Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  ...
  "First Author Research Publication": [
    { name: "paperTitle", label: "Paper Title", type: "text", required: true },
    { name: "journalName", label: "Journal / Venue Name", type: "text", required: true },
    { name: "authors", label: "All Authors", type: "textarea", helperText: "List all co-authors in order." },
    { name: "publicationYear", label: "Publication Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  "Co-author Research Publication": [
    { name: "paperTitle", label: "Paper Title", type: "text", required: true },
    { name: "journalName", label: "Journal / Venue Name", type: "text", required: true },
    { name: "correspondingAuthor", label: "Corresponding / First Author", type: "text" },
    { name: "publicationYear", label: "Publication Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  ...
  "International Conference Full Paper": [
    ...
    { name: "conferenceLocation", label: "Location / Country", type: "text" },
  ...
  "Conference Abstract Publication": [
    { name: "abstractTitle", label: "Abstract / Paper Title", type: "text", required: true },
    { name: "conferenceName", label: "Conference Name", type: "text", required: true },
    { name: "year", label: "Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  "Poster Presentation": [
    { name: "posterTitle", label: "Poster / Paper Title", type: "text", required: true },
    { name: "conferenceName", label: "Conference / Event Name", type: "text", required: true },
    { name: "location", label: "Location / City", type: "text" },
    { name: "year", label: "Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  ...
  "Track Chair Role": [
    { name: "trackName", label: "Track / Session Name", type: "text", required: true },
    { name: "conferenceName", label: "Conference Name", type: "text", required: true },
    { name: "year", label: "Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  "Technical Program Committee (TPC) Member": [
    { name: "conferenceName", label: "Conference Name", type: "text", required: true },
    { name: "role", label: "Your Role in Committee", type: "text" },
    { name: "year", label: "Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  "Session Chair": [
    { name: "sessionTitle", label: "Session / Track Title", type: "text", required: true },
    { name: "conferenceName", label: "Conference Name", type: "text", required: true },
    { name: "year", label: "Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  ...
  "Edited Book Contribution": [
    { name: "contributionTitle", label: "Your Contribution Title", type: "text", required: true },
    { name: "editedBy", label: "Book Editors", type: "textarea" },
  ...
  "Major Research Grant (>20L)": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "fundingAgency", label: "Funding Agency / Body", type: "text" },
    { name: "amount", label: "Sanctioned Amount (INR)", type: "number" },
    { name: "duration", label: "Project Duration", type: "text", placeholder: "e.g., 2 years" },
    { name: "piDetails", label: "Your Role (PI / Co-PI)", type: "text" },
  ],
  "Major Grant (5L–20L)": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "fundingAgency", label: "Funding Agency / Body", type: "text" },
    { name: "amount", label: "Sanctioned Amount (INR)", type: "number" },
    { name: "duration", label: "Project Duration", type: "text", placeholder: "e.g., 1 year" },
  ],
  ...
  "Principal Investigator (PI) Role": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "fundingAgency", label: "Funding Agency / Body", type: "text" },
    { name: "amount", label: "Total Project Amount (INR)", type: "number" },
    { name: "scope", label: "Project Scope / Objectives", type: "textarea", fullWidth: true },
  ],
  "Co-PI Role": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "piName", label: "Principal Investigator Name", type: "text" },
    { name: "fundingAgency", label: "Funding Agency / Body", type: "text" },
    { name: "amount", label: "Total Project Amount (INR)", type: "number" },
  ],
  "Sponsored Industry Project": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "sponsoringOrganization", label: "Sponsoring Company / Organization", type: "text" },
  ...
  "International Patent Filed": [
    ...
    { name: "country", label: "Country / Countries", type: "text" },
    { name: "filingDate", label: "Filing Date", type: "date" },
    { name: "coInventors", label: "Co-Inventors (if any)", type: "textarea" },
  ],
  ...
  "National Patent Granted": [
    { name: "patentTitle", label: "Patent Title", type: "text", required: true },
    { name: "patentNumber", label: "Patent / Grant Number", type: "text" },
    { name: "grantDate", label: "Grant Date", type: "date" },
  ],
  "Copyright Filed": [
    { name: "workTitle", label: "Title of Work", type: "text", required: true },
    { name: "workType", label: "Type of Work", type: "select", options: ["Software", "Literary Work", "Artistic Work", "Musical Work", "Other"] },
    { name: "filingDate", label: "Filing Date", type: "date" },
  ],
  ...
  "Journal Reviewer (Scopus/WOS)": [
    { name: "journalName", label: "Journal Name", type: "text", required: true },
    { name: "indexing", label: "Indexing Type", type: "select", options: ["Scopus", "Web of Science", "Both"] },
  ...
  "Editor-in-Chief": [
    { name: "journalName", label: "Journal Name", type: "text", required: true },
    { name: "duration", label: "Duration / Tenure", type: "text" },
  ...
  "PhD Scholar Guidance": [
    ...
    { name: "thesisTitle", label: "Thesis Title / Research Topic", type: "text" },
    { name: "registrationYear", label: "Year of Registration", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  ...
  "PhD Thesis Awarded": [
    { name: "scholarName", label: "Scholar Name", type: "text", required: true },
    { name: "thesisTitle", label: "Thesis Title", type: "text" },
    { name: "awardDate", label: "Award / Completion Date", type: "date" },
  ],
  "Masters Dissertation Guidance": [
    { name: "studentName", label: "Student Name", type: "text", required: true },
    { name: "dissertationTitle", label: "Dissertation Title / Topic", type: "text" },
    { name: "program", label: "Program / Course", type: "text" },
  ],
  "Research Seminar Guidance": [
    { name: "seminarTitle", label: "Seminar / Session Title", type: "text", required: true },
  ...
  "Workshop for Students": [
    ...
    { name: "skillsDeveloped", label: "Skills Developed / Topics Covered", type: "textarea" },
  ],
  "Career Counselling Session": [
    { name: "sessionTopic", label: "Session Topic / Title", type: "text", required: true },
    { name: "date", label: "Date", type: "date" },
    { name: "studentsAttended", label: "Number of Students Attended", type: "number" },
  ],
  "Study Visit / Industrial Visit": [
    { name: "visitTitle", label: "Visit Title", type: "text", required: true },
    { name: "organization", label: "Organization / Place Visited", type: "text" },
    { name: "date", label: "Date", type: "date" },
    { name: "studentCount", label: "Number of Students", type: "number" },
  ],
  "Field Work Activity": [
    ...
    { name: "duration", label: "Duration", type: "text", placeholder: "e.g., 1 day, 3 hours" },
    { name: "learningOutcomes", label: "Learning Outcomes / Observations", type: "textarea", fullWidth: true },
  ],
  ...
  "Hackathon Organized": [
    { name: "hackathonName", label: "Hackathon / Event Name", type: "text", required: true },
    { name: "dates", label: "Dates", type: "text", placeholder: "DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY", pattern: "^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4}( to (0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4})?$", helperText: "Format: DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY (e.g. 16-04-2025 or 16-04-2025 to 20-04-2025)" },
    { name: "participants", label: "Number of Participants", type: "number" },
    { name: "prizes", label: "Prizes / Awards Given", type: "textarea" },
  ],
  "Student Club Activity": [
    { name: "clubName", label: "Club Name", type: "text", required: true },
    { name: "activityTitle", label: "Activity / Event Title", type: "text" },
    { name: "date", label: "Date", type: "date" },
  ...
  "Technical Body Support": [
    { name: "bodyName", label: "Technical Body / Club Name", type: "text", required: true },
    { name: "activitySupported", label: "Activity / Support Provided", type: "textarea" },
  ],
  "Cultural Event Support (Skream/Symphony etc.)": [
    { name: "eventName", label: "Event Name", type: "text", required: true },
    { name: "date", label: "Date", type: "date" },
    { name: "roleInEvent", label: "Your Role", type: "select", options: ["Organizer", "Coordinator", "Volunteer", "Judge", "Mentor"] },
  ],
  "Sports Event Support": [
    { name: "eventName", label: "Sports Event Name", type: "text", required: true },
    { name: "date", label: "Date", type: "date" },
    { name: "role", label: "Your Role", type: "select", options: ["Organizer", "Coordinator", "Volunteer", "Mentor"] },
  ],
  ...
  "Conference Organized": [
    ...
    { name: "dates", label: "Dates", type: "text", placeholder: "DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY", pattern: "^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4}( to (0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4})?$", helperText: "Format: DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY (e.g. 16-04-2025 or 16-04-2025 to 20-04-2025)" },
    { name: "participants", label: "Number of Participants", type: "number" },
    { name: "role", label: "Your Role", type: "select", options: ["Convener", "Coordinator", "Co-Coordinator", "Team Member"] },
  ],
  "FDP Organized": [
    { name: "fdpTitle", label: "FDP Title", type: "text", required: true },
    { name: "dates", label: "Dates", type: "text", placeholder: "DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY", pattern: "^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4}( to (0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4})?$", helperText: "Format: DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY (e.g. 16-04-2025 or 16-04-2025 to 20-04-2025)" },
    { name: "participants", label: "Number of Participants", type: "number" },
    { name: "role", label: "Your Role", type: "select", options: ["Convener", "Coordinator", "Co-Coordinator"] },
  ],
  "STTP Organized": [
    { name: "sttpTitle", label: "STTP / Program Title", type: "text", required: true },
    { name: "dates", label: "Dates", type: "text", placeholder: "DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY", pattern: "^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4}( to (0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4})?$", helperText: "Format: DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY (e.g. 16-04-2025 or 16-04-2025 to 20-04-2025)" },
    { name: "participants", label: "Number of Participants", type: "number" },
  ],
  ...
  "Coordinator Role in FDP": [
    { name: "fdpTitle", label: "FDP / Program Title", type: "text", required: true },
    { name: "coordinationDetails", label: "Your Coordination / Responsibilities", type: "textarea" },
  ],
  "Co-coordinator Role": [
    { name: "eventTitle", label: "Event / Program Title", type: "text", required: true },
    { name: "eventType", label: "Type of Event", type: "text" },
    { name: "roleDetails", label: "Your Role / Responsibilities", type: "textarea" },
  ],
  "Team Member in Organizing": [
    { name: "eventTitle", label: "Event / Program Title", type: "text", required: true },
    { name: "responsibilities", label: "Your Responsibilities", type: "textarea" },
  ],
  ...
  "Invited Talk at Other Institute": [
    { name: "instituteOrganization", label: "Institute / Organization Name", type: "text", required: true },
    { name: "talkTitle", label: "Talk Title / Topic", type: "text" },
    { name: "date", label: "Date", type: "date" },
  ],
  "Expert Session Conducted": [
    { name: "sessionTitle", label: "Session Title / Topic", type: "text", required: true },
    { name: "organizationName", label: "Organization / Institute", type: "text" },
    { name: "date", label: "Date", type: "date" },
    { name: "participants", label: "Number of Participants", type: "number" },
  ],
  "Extension Lecture": [
    { name: "lectureTitle", label: "Lecture Title / Topic", type: "text", required: true },
  ...
  "Public Lecture": [
    ...
    { name: "date", label: "Date", type: "date" },
    { name: "audience", label: "Audience / Attendees", type: "text" },
  ],
  "Conference Judge": [
    { name: "conferenceName", label: "Conference / Event Name", type: "text", required: true },
    { name: "role", label: "Your Judging Role", type: "text" },
    { name: "date", label: "Date", type: "date" },
  ],
  "External Examiner": [
  ...
  "BOS Member": [
    { name: "bosMembership", label: "Board of Studies Name", type: "text", required: true },
    { name: "institution", label: "Institution / University", type: "text" },
    { name: "year", label: "Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  "FOET / AAB / AC Member": [
    { name: "committeeName", label: "Committee / Body Name", type: "text", required: true },
    { name: "institution", label: "Institution / University", type: "text" },
    { name: "year", label: "Year", type: "number", min: 1950, max: 2100, placeholder: "YYYY" },
  ],
  ...
  "International Teaching Interaction": [
    { name: "interactionTitle", label: "Interaction / Program Title", type: "text", required: true },
    { name: "country", label: "Country", type: "text" },
    { name: "institution", label: "Foreign Institution", type: "text" },
    { name: "date", label: "Date", type: "date" },
  ],
  "Corporate Interaction": [
    { name: "companyName", label: "Company / Industry Name", type: "text", required: true },
    { name: "interactionType", label: "Type / Purpose of Interaction", type: "text", placeholder: "e.g., MoU, Guest Talk, Project Discussion" },
    { name: "date", label: "Date", type: "date" },
  ],
  "Recognition/Award from External Body": [
    { name: "awardTitle", label: "Award / Recognition Title", type: "text", required: true },
    { name: "awardingBody", label: "Awarding Body / Organization", type: "text" },
  ...
  "Faculty Development Program (FDP) Attended": [
    { name: "fdpTitle", label: "FDP / Program Title", type: "text", required: true },
    { name: "organizer", label: "Organizer / Institution", type: "text" },
    { name: "dates", label: "Dates", type: "text", placeholder: "DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY", pattern: "^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4}( to (0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4})?$", helperText: "Format: DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY (e.g. 16-04-2025 or 16-04-2025 to 20-04-2025)" },
  ...
  "Refresher Course": [
    { name: "courseTitle", label: "Course / Program Title", type: "text", required: true },
    { name: "organizer", label: "Organizer / Institution", type: "text" },
    { name: "dates", label: "Dates", type: "text", placeholder: "DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY", pattern: "^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4}( to (0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4})?$", helperText: "Format: DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY (e.g. 16-04-2025 or 16-04-2025 to 20-04-2025)" },
  ],
  "Orientation Program": [
  ...
  "International Training Program": [
    { name: "programTitle", label: "Program / Training Title", type: "text", required: true },
    { name: "country", label: "Country", type: "text" },
    { name: "dates", label: "Dates", type: "text", placeholder: "DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY", pattern: "^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4}( to (0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-[0-9]{4})?$", helperText: "Format: DD-MM-YYYY or DD-MM-YYYY to DD-MM-YYYY (e.g. 16-04-2025 or 16-04-2025 to 20-04-2025)" },
  ],
  ...
  "Consultancy Project In Progress": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "client", label: "Client / Organization", type: "text" },
    { name: "amount", label: "Consultancy Amount (INR)", type: "number" },
    { name: "duration", label: "Expected Duration", type: "text", placeholder: "e.g., 6 months, 1 year" },
  ],
  ...
  "Industry Sponsored Consultancy": [
    { name: "projectTitle", label: "Project Title", type: "text", required: true },
    { name: "sponsor", label: "Sponsoring Industry / Company", type: "text" },
    { name: "deliverables", label: "Key Deliverables / Outcomes", type: "textarea", fullWidth: true },
  ],
  "Technical Advisory Role": [
    { name: "advisoryRole", label: "Advisory Role / Title", type: "text", required: true },
    { name: "organization", label: "Organization / Company", type: "text" },
    { name: "duration", label: "Duration / Tenure", type: "text" },
  ],
  "Problem Solving Consultancy": [
    { name: "problem", label: "Problem / Challenge Addressed", type: "textarea", required: true, fullWidth: true },
    { name: "solution", label: "Solution / Outcome Delivered", type: "textarea", fullWidth: true },
  ],
};
